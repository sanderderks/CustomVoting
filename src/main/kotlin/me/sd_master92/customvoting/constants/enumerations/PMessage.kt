...
)
{
    ...
    CRATE_ITEM_NAME_NO_PRIZE(RED.color),
    ...
    CRATE_MESSAGE_GIVE_KEY(GREEN.color),
    ...
    CRATE_MESSAGE_CHEST_LOCATION_SET_X(GREEN.color),
    CRATE_MESSAGE_CHEST_LOCATION_UNSET_X(RED.color),
    CRATE_MESSAGE_GIVE_KEY_COMMAND_USAGE(RED.color),
    CRATE_ERROR_GIVE_KEY(RED.color),
    CRATE_ERROR_NOT_FOUND(RED.color),
    ...
    DATABASE_ERROR_NOT_FUNCTIONING(RED.color),
    DATABASE_ITEM_NAME(RED.color),
    DATABASE_ITEM_LORE(GRAY.color),

    DISABLED_WORLD_OVERVIEW_INVENTORY_NAME_X,
    ...
    DISABLED_WORLD_ITEM_NAME_TYPE(PURPLE.color),
    ...
    DOUBLE_REWARDS_ITEM_NAME(PURPLE.color),
    DOUBLE_REWARDS_ITEM_NAME_X(PURPLE.color),
    DOUBLE_REWARDS_ITEM_LORE(GRAY.color),
    ...
    PREFIX_SUPPORT_ITEM_NAME(RED.color),
    PREFIX_SUPPORT_MESSAGE_INPUT(GREEN.color),
    PREFIX_SUPPORT_MESSAGE_INPUT_CHANGED(GREEN.color),
    ...
    PERM_USER_OVERVIEW_INVENTORY_NAME,
    ...
    GENERAL_VALUE_NONE(RED.color),
    GENERAL_VALUE_BLACKLIST,
    GENERAL_VALUE_WHITELIST,
    GENERAL_FORMAT_DATE,
    GENERAL_UNIT_URL,
    ...
    MIGRATE_VOTES_COMMAND_INVENTORY_NAME_TO_DATABASE_CONFIRM,
    MIGRATE_VOTES_COMMAND_INVENTORY_NAME_TO_PLAYERFILES_CONFIRM,
    MIGRATE_VOTES_COMMAND_USAGE(RED.color),
    MIGRATE_VOTES_MESSAGE_TO_DATABASE_SUCCESS_X(GREEN.color, AQUA.color),
    MIGRATE_VOTES_MESSAGE_TO_PLAYERFILES_SUCCESS_X(GREEN.color, AQUA.color),
    MIGRATE_VOTES_COMMAND_MESSAGE_DATABASE_REQUIRED(RED.color),
    MIGRATE_VOTES_MESSAGE_FAILURE(RED.color),
    ...
    IGNORE_PLAYERNAME_CASING_ITEM_NAME(RED.color),
    IGNORE_PLAYERNAME_CASING_ITEM_LORE(GRAY.color),
    ...
    VOTE_ITEM_NAME_DELAY(PURPLE.color),

    VOTE_INFO_INVENTORY_NAME,
    VOTE_INFO_INVENTORY_NAME_OTHERS_X,
    VOTE_INFO_ITEM_NAME(PURPLE.color),

    VOTE_SITES_INVENTORY_NAME_EDITOR,
    VOTE_SITES_ITEM_LORE(GRAY.color),
    VOTE_SITES_ITEM_NAME(PURPLE.color),
    VOTE_SITES_ITEM_NAME_GUI(PURPLE.color),
    VOTE_SITES_MESSAGE_DESCRIPTION_ENTER(GREEN.color),
    VOTE_SITES_MESSAGE_DESCRIPTION_ENTER_MORE(GREEN.color),
    VOTE_SITES_MESSAGE_TITLE_ENTER(GREEN.color),
    VOTE_SITES_MESSAGE_URL(GREEN.color),
    VOTE_SITES_MESSAGE_TIME(GREEN.color),
    VOTE_SITES_MESSAGE_TIME_SETTING(GREEN.color),
    VOTE_SITES_MESSAGE_DESCRIPTION_DEFAULT(GRAY.color),
    VOTE_SITES_MESSAGE_URL_DEFAULT(RED.color),
    VOTE_SITES_MESSAGE_SETUP(RED.color),
    VOTE_SITES_MESSAGE_DEACTIVATE(RED.color),
    VOTE_SITES_UNIT_INTERVAL,
    VOTE_SITES_UNIT_TIME_OF_DAY,
    ...
    VOTE_PARTY_ITEM_NAME_LOCATION_SET(PURPLE.color),
    VOTE_PARTY_ITEM_LORE_LOCATION_STATUS(RED.color),
    ...
    VOTE_PARTY_MESSAGE_CHEST_LOCATION_SET_X(GREEN.color),
    VOTE_PARTY_MESSAGE_CHEST_LOCATION_SET_ALREADY_X(RED.color),
    VOTE_PARTY_MESSAGE_CHEST_LOCATION_UNSET_X(RED.color),
    ...
    VOTE_PARTY_ITEM_LORE_LOCATION_SET(GRAY.color),
    ...
    VOTE_STREAK_ITEM_NAME_CONSECUTIVE(PURPLE.color),
