...
)
{
    ...
    ENABLED_GROUP_OVERVIEW_INVENTORY_NAME("Enabled Groups"),
    ENABLED_GROUP_OVERVIEW_ITEM_NAME("Enabled Groups", PURPLE),
    ENABLED_GROUP_ITEM_NAME_X("$X", PURPLE),

    ENABLED_USER_OVERVIEW_INVENTORY_NAME_X("Enabled Users #$X"),
    ENABLED_USER_OVERVIEW_ITEM_LORE("This setting overrides;;${GRAY}the group permissions.", GRAY),
    ENABLED_USER_OVERVIEW_ITEM_NAME("Enabled Users", PURPLE),
    ...
    GENERAL_MESSAGE_LIST_REMOVED_XY("Removed $X from $Y"),
    ...
    MILESTONE_MESSAGE_DELETED_X("$X deleted!", RED),
