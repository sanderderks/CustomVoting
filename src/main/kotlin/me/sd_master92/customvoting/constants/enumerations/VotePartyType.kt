...
enum class VotePartyType(private val label_: PMessage, val requiresLocation: Boolean = true) : CarouselEnum
{
    ...
    ADD_TO_INVENTORY(PMessage.ENUM_VOTE_PARTY_TYPE_ADD_TO_INVENTORY, false),
